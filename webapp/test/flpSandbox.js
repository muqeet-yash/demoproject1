		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#m618demoproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"m618demoproject1-display": {
								"semanticObject": "m618demoproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=m618.demoproject1",
									"url": sap.ui.require.toUrl("m618/demoproject1")
								}
							}
						}
					}
